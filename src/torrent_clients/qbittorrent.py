...
async def match_tracker_url(tracker_urls: list[str], meta: dict[str, Any]) -> None:
    tracker_url_patterns = {
        ...
        'cbr': ["capybarabr.com"],
        # CHDBITS has multiple valid announce domains; any one means the
        # torrent is already present for CHDBITS and must be skipped.
        'chdbits': ["ptchdbits.co/announce", "chdbits.xyz/announce"],
        ...
        'ttg': ["tracker.totheglory.im", "totheglory.im/announce"],
